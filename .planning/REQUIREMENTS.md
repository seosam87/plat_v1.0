...
- [ ] **SITE-V4-01**: Пользователь может управлять сайтами через подпункты sidebar секции «Сайты»
...
- [ ] **KW-V4-01**: Ключевые слова, позиции, кластеры, каннибализация, интент и массовые операции доступны через подпункты sidebar
- [ ] **KW-V4-02**: Все страницы секции используют sticky site selector — при смене сайта контент перезагружается без перехода
- [ ] **KW-V4-03**: Загрузка файлов (Topvisor, KC, SF) доступна из этой секции

### Секция «Аналитика»

- [ ] **AN-V4-01**: Analytics Workspace, Gap-анализ, Архитектура, Metrika и Анализ трафика доступны через подпункты sidebar
- [ ] **AN-V4-02**: Конкуренты доступны как подпункт «Аналитики»

### Секция «Контент»

- [ ] **CNT-V4-01**: Content Audit, WP Pipeline, DOCX Publisher доступны через подпункты sidebar
- [ ] **CNT-V4-02**: Проекты, Kanban и Контент-план доступны как подпункты секции «Контент»
- [ ] **CNT-V4-03**: Мониторинг изменений доступен как подпункт секции «Контент»

### Секция «Настройки»

- [ ] **CFG-V4-01**: Управление пользователями, группами, источниками данных, прокси, параметрами и журналом аудита через подпункты sidebar
- [ ] **CFG-V4-02**: Секция «Настройки» видна только пользователям с ролью admin
...
| SITE-V4-02 | Phase v4-03: Секция «Сайты» | Complete |
