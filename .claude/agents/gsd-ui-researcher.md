...
Use template from `/projects/test/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/projects/test/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/projects/test/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
