...
Reference full template: `/projects/test/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/projects/test/.claude/get-shit-done/templates/state.md`.
