...
<execution_context>
@/projects/test/.claude/get-shit-done/workflows/list-workspaces.md
@/projects/test/.claude/get-shit-done/references/ui-brand.md
</execution_context>

<process>
Execute the list-workspaces workflow from @/projects/test/.claude/get-shit-done/workflows/list-workspaces.md end-to-end.
</process>
