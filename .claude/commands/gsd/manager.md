...
<execution_context>
@/projects/test/.claude/get-shit-done/workflows/manager.md
...
<process>
Execute the manager workflow from @/projects/test/.claude/get-shit-done/workflows/manager.md end-to-end.
