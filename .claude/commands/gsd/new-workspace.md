...
<execution_context>
@/projects/test/.claude/get-shit-done/workflows/new-workspace.md
@/projects/test/.claude/get-shit-done/references/ui-brand.md
</execution_context>

<process>
Execute the new-workspace workflow from @/projects/test/.claude/get-shit-done/workflows/new-workspace.md end-to-end.
