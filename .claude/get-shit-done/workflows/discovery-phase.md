...
See /projects/test/.claude/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using /projects/test/.claude/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using /projects/test/.claude/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from /projects/test/.claude/get-shit-done/templates/discovery.md
...
Use /projects/test/.claude/get-shit-done/templates/discovery.md.
