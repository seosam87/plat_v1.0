...
<!-- For checkpoint task examples and patterns, see @/projects/test/.claude/get-shit-done/references/checkpoints.md -->
...
See `/projects/test/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/projects/test/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/projects/test/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
